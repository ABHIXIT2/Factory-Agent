        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "owner_phone": {"type": "string", "minLength": 1, "maxLength": 20},
                    "address": {"type": "string", "minLength": 1, "maxLength": 500},
                    "credit_limit": {"type": "number", "minimum": 0},
                },
                "required": ["shop_name", "owner_name", "owner_phone", "address"],
            },
        },
    },
    {
...
def _load_message_templates() -> dict:
    ...
    if not yaml_file.exists():
        logger.warning("messages.yaml not found at %s, using empty registry", yaml_file)
        return {}
